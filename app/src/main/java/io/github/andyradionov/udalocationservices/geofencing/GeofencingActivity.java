...
import io.github.andyradionov.udalocationservices.MainActivity;
...
public class GeofencingActivity extends AppCompatActivity {
    ...
    public void populateGeofenceList() {
        for (Map.Entry<String, LatLng> entry : Constants.OMSK_LANDMARKS.entrySet()) {
    ...
    public void testSendNotification(View view) {
